...
//
// !!! BREAKING - ToDo:
// `takeLatest`, `takeEvery` and `all` typings are not yet added to `flow-typed`, we had to add them ourselves.
// @see https://github.com/flowtype/flow-typed/issues/569
//
/**
